              ...
              <div key={groupIndex} className="flex">
                {carouselTexts.map((text, index) => (
                  <span
                    ...
                    className="mx-8 text-[11px] mr-32  tracking-wider text-white uppercase"
                  >
                    {text}
                  </span>
                ))}
          ...
          <div className="flex items-center justify-end space-x-6">
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="shop=bag">
                  <rect id="Rectangle 2" x="5" y="7" width="14" height="12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                  <path id="Rectangle 2_2" d="M8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                </g>
              </svg>
            </Link>
          </div>
